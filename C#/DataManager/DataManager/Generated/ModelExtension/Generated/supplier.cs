...
namespace DataManager.Model
{
    public partial class supplier : IDataModel
    {
        ...
        {
                        var query0 = from obj in db.contacts
                         where obj.supplier_id == this.supplier_id
                         select obj;

            var query1 = from obj in db.device_history
                         where obj.supplier_id == this.supplier_id
                         select obj;
        ...
        {
            var obj = db.suppliers.SingleOrDefault(d => d.supplier_id == this.supplier_id);
