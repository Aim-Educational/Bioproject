...
{
    public partial class contact_type : IDataModel
    {
        public bool isDeletable(PlanningContext db)
        {
                        var query0 = from obj in db.contacts
                         where obj.contact_type_id == this.contact_type_id
                         select obj;
        ...
        {
            var obj = db.contact_type.SingleOrDefault(d => d.contact_type_id == this.contact_type_id);
