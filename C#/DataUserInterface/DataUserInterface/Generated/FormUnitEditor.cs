...
{
    public partial class FormUnitEditor : Form
    {
        private static unit _defaultObject = new unit();

        public int id { private set; get; }
        private unit _cached { set; get; }
        ...
        private void reload()
        {
            using (var db = new PlanningContext())
            {
                if (this.mode != EnumEditorMode.Create)
                {
                    ...
                    if (obj != null)
                    {
                        this.textboxID.Text = Convert.ToString(obj.unit_id);
                        this.textboxDescription.Text = obj.description;
                        this.textboxComment.Text = obj.comment;
                        this.textboxAbbrev.Text = obj.abbreviation;
        ...
        public FormUnitEditor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            InitializeComponent();
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = FormUnitEditor._defaultObject;
        ...
        private void modifyOnClick()
        {
            ...
            using (var db = new PlanningContext())
            {
                ...
                obj.abbreviation = this.textboxAbbrev.Text;
        ...
        private void textboxAbbrev_Leave(object sender, EventArgs e)
        {
            if (textboxAbbrev.Text != this._cached.abbreviation)
                this._isDirty = true;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.textboxAbbrev = new System.Windows.Forms.TextBox();
            ...
            this.splitContainer1.Panel2.Controls.Add(this.textboxAbbrev);
            ...
            this.splitContainer1.Size = new System.Drawing.Size(330, 141);
            ...
            this.buttonDelete.Location = new System.Drawing.Point(85, 113);
            ...
            this.buttonReload.Location = new System.Drawing.Point(4, 114);
            ...
            this.buttonAction.Location = new System.Drawing.Point(141, 113);
            ...
            // textboxAbbrev
            // 
            this.textboxAbbrev.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textboxAbbrev.Location = new System.Drawing.Point(3, 64);
            this.textboxAbbrev.Name = "textboxAbbrev";
            this.textboxAbbrev.Size = new System.Drawing.Size(208, 20);
            this.textboxAbbrev.TabIndex = 33;
            this.textboxAbbrev.Leave += new System.EventHandler(this.textboxAbbrev_Leave);
            // 
            // textboxComment
            // 
            this.textboxComment.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textboxComment.Location = new System.Drawing.Point(3, 90);
            this.textboxComment.Name = "textboxComment";
            this.textboxComment.Size = new System.Drawing.Size(208, 20);
            this.textboxComment.TabIndex = 34;
