...
{
    public partial class FormHistoryEventEditor : Form
    {
        private static history_event _defaultObject = new history_event();

        public int id { private set; get; }
        private history_event _cached { set; get; }
        ...
        private void reload()
        {
            using (var db = new PlanningContext())
            {
                ...
                if (this.mode != EnumEditorMode.Create)
                {
                    var obj = db.history_event.SingleOrDefault(v => v.history_event_id == this.id);
                    if (obj != null)
                    {
                        this.textboxHistoryEventId.Text = Convert.ToString(obj.history_event_id);
this.textboxDescription.Text = obj.description;
        ...
        public FormHistoryEventEditor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            InitializeComponent();
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = FormHistoryEventEditor._defaultObject;
...
obj.description = this.textboxDescription.Text;
        ...
        private void createOnClick()
        {
            ...
            using (var db = new PlanningContext())
            {
                var obj = new history_event();

                
obj.description = this.textboxDescription.Text;


                db.history_event.Add(obj);
                db.SaveChanges();
                this._cached  = obj;
                this.id       = obj.history_event_id;
                this._isDirty = false;
        ...
        private void buttonReload_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
                ...
                private void textboxHistoryEventId_Leave(object sender, EventArgs e)
        {
            // The Convert.ToString is just in case the value we're comparing to is something like an int.
            if (this.textboxHistoryEventId.Text != Convert.ToString(this._cached.history_event_id))
                this._isDirty = true;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormHistoryEventEditor));
            this.splitContainer1 = new System.Windows.Forms.SplitContainer();
            this.labelDirty = new System.Windows.Forms.Label();
            this.buttonDelete = new System.Windows.Forms.Button();
            this.buttonReload = new System.Windows.Forms.Button();
            this.buttonAction = new System.Windows.Forms.Button();
            this.textboxHistoryEventId = new System.Windows.Forms.TextBox();
this.labelHistoryEventId = new System.Windows.Forms.Label();
...
this.labelDescription = new System.Windows.Forms.Label();
            ...
            this.splitContainer1.Panel1.Controls.Add(labelHistoryEventId);
this.splitContainer1.Panel1.Controls.Add(labelDescription);
            ...
            this.splitContainer1.Panel2.Controls.Add(textboxHistoryEventId);
this.splitContainer1.Panel2.Controls.Add(textboxDescription);
            ...
            this.buttonAction.Click += new System.EventHandler(this.buttonSave_Click);
                        // 
            // textboxHistoryEventId
            // 
            this.textboxHistoryEventId.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textboxHistoryEventId.Location = new System.Drawing.Point(4, 12);
            this.textboxHistoryEventId.Name = "textboxHistoryEventId";
            this.textboxHistoryEventId.Size = new System.Drawing.Size(208, 20);
            this.textboxHistoryEventId.TabIndex = 31;
            this.textboxHistoryEventId.Leave += new System.EventHandler(this.textboxHistoryEventId_Leave);
            this.textboxHistoryEventId.Enabled = false;
                        // 
            // labelHistoryEventId
            // 
            this.labelHistoryEventId.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.labelHistoryEventId.AutoSize = true;
            this.labelHistoryEventId.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelHistoryEventId.Location = new System.Drawing.Point(0, 12);
            this.labelHistoryEventId.Name = "labelHistoryEventId";
            this.labelHistoryEventId.Size = new System.Drawing.Size(30, 20);
            this.labelHistoryEventId.TabIndex = 14;
            this.labelHistoryEventId.Text = "ID";
            this.labelHistoryEventId.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
                        // 
            // textboxDescription
            // 
            ...
            // 
            // FormHistoryEventEditor
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(330, 104);
            this.Controls.Add(this.splitContainer1);
            this.Name = "FormHistoryEventEditor";
            this.Text = "HistoryEvent Editor";
        ...
        private System.Windows.Forms.TextBox textboxHistoryEventId;
private System.Windows.Forms.Label labelHistoryEventId;
