...
{
    public partial class FormBBCRSSVisibilityEditor : Form
    {
        private static bbc_rss_visibility _defaultObject = new bbc_rss_visibility();

        public int id { private set; get; }
        private bbc_rss_visibility _cached { set; get; }
        ...
        private void reload()
        {
            using (var db = new PlanningContext())
            {
                ...
                if (this.mode != EnumEditorMode.Create)
                {
                    var obj = db.bbc_rss_visibility.SingleOrDefault(v => v.bbc_rss_visibility_id == this.id);
                    if (obj != null)
                    {
                        this.textboxBBCRSSVisibilityId.Text = Convert.ToString(obj.bbc_rss_visibility_id);
...
this.textboxComment.Text = obj.comment;
        ...
        public FormBBCRSSVisibilityEditor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            InitializeComponent();
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = FormBBCRSSVisibilityEditor._defaultObject;
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new PlanningContext())
            {
                ...
                db.bbc_rss_visibility.Remove(obj);
                db.SaveChanges();
                this.Close();
            }
        }
...
obj.comment = this.textboxComment.Text;
        ...
        private void createOnClick()
        {
            ...
            using (var db = new PlanningContext())
            {
                var obj = new bbc_rss_visibility();
...
obj.comment = this.textboxComment.Text;
                ...
                db.bbc_rss_visibility.Add(obj);
                db.SaveChanges();
                this._cached  = obj;
                this.id       = obj.bbc_rss_visibility_id;
                this._isDirty = false;
        ...
        private void buttonReload_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
                ...
                private void textboxBBCRSSVisibilityId_Leave(object sender, EventArgs e)
        {
            // The Convert.ToString is just in case the value we're comparing to is something like an int.
            if (this.textboxBBCRSSVisibilityId.Text != Convert.ToString(this._cached.bbc_rss_visibility_id))
                this._isDirty = true;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormBBCRSSVisibilityEditor));
            this.splitContainer1 = new System.Windows.Forms.SplitContainer();
            this.labelDirty = new System.Windows.Forms.Label();
            this.buttonDelete = new System.Windows.Forms.Button();
            this.buttonReload = new System.Windows.Forms.Button();
            this.buttonAction = new System.Windows.Forms.Button();
            this.textboxBBCRSSVisibilityId = new System.Windows.Forms.TextBox();
this.labelBBCRSSVisibilityId = new System.Windows.Forms.Label();
...
this.labelComment = new System.Windows.Forms.Label();
            ...
            this.splitContainer1.Panel1.Controls.Add(labelBBCRSSVisibilityId);
...
this.splitContainer1.Panel1.Controls.Add(labelComment);
            ...
            this.splitContainer1.Panel2.Controls.Add(textboxBBCRSSVisibilityId);
...
this.splitContainer1.Panel2.Controls.Add(textboxComment);
            ...
            this.buttonAction.Click += new System.EventHandler(this.buttonSave_Click);
                        // 
            // textboxBBCRSSVisibilityId
            // 
            this.textboxBBCRSSVisibilityId.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textboxBBCRSSVisibilityId.Location = new System.Drawing.Point(4, 12);
            this.textboxBBCRSSVisibilityId.Name = "textboxBBCRSSVisibilityId";
            this.textboxBBCRSSVisibilityId.Size = new System.Drawing.Size(208, 20);
            this.textboxBBCRSSVisibilityId.TabIndex = 31;
            this.textboxBBCRSSVisibilityId.Leave += new System.EventHandler(this.textboxBBCRSSVisibilityId_Leave);
            this.textboxBBCRSSVisibilityId.Enabled = false;
                        // 
            // labelBBCRSSVisibilityId
            // 
            this.labelBBCRSSVisibilityId.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.labelBBCRSSVisibilityId.AutoSize = true;
            this.labelBBCRSSVisibilityId.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelBBCRSSVisibilityId.Location = new System.Drawing.Point(0, 12);
            this.labelBBCRSSVisibilityId.Name = "labelBBCRSSVisibilityId";
            this.labelBBCRSSVisibilityId.Size = new System.Drawing.Size(30, 20);
            this.labelBBCRSSVisibilityId.TabIndex = 14;
            this.labelBBCRSSVisibilityId.Text = "ID";
            this.labelBBCRSSVisibilityId.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
                        // 
            // textboxDescription
            // 
            ...
            // 
            // FormBBCRSSVisibilityEditor
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(330, 130);
            this.Controls.Add(this.splitContainer1);
            this.Name = "FormBBCRSSVisibilityEditor";
            this.Text = "BBCRSSVisibility Editor";
        ...
        private System.Windows.Forms.TextBox textboxBBCRSSVisibilityId;
private System.Windows.Forms.Label labelBBCRSSVisibilityId;
