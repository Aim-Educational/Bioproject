...
{
    public partial class FormContactTypeEditor : Form
    {
        private static contact_type _defaultObject = new contact_type();

        public int id { private set; get; }
        private contact_type _cached { set; get; }
        ...
        private void reload()
        {
            using (var db = new PlanningContext())
            {
                ...
                if (this.mode != EnumEditorMode.Create)
                {
                    var obj = db.contact_type.SingleOrDefault(v => v.contact_type_id == this.id);
                    if (obj != null)
                    {
                        this.textboxContactTypeId.Text = Convert.ToString(obj.contact_type_id);
...
this.textboxComment.Text = obj.comment;
        ...
        public FormContactTypeEditor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            InitializeComponent();
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = FormContactTypeEditor._defaultObject;
...
obj.comment = this.textboxComment.Text;
                ...
                db.contact_type.Add(obj);
                db.SaveChanges();
                this._cached  = obj;
                this.id       = obj.contact_type_id;
                this._isDirty = false;
        ...
        private void buttonReload_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
                ...
                private void textboxContactTypeId_Leave(object sender, EventArgs e)
        {
            // The Convert.ToString is just in case the value we're comparing to is something like an int.
            if (this.textboxContactTypeId.Text != Convert.ToString(this._cached.contact_type_id))
                this._isDirty = true;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormContactTypeEditor));
            this.splitContainer1 = new System.Windows.Forms.SplitContainer();
            this.labelDirty = new System.Windows.Forms.Label();
            this.buttonDelete = new System.Windows.Forms.Button();
            this.buttonReload = new System.Windows.Forms.Button();
            this.buttonAction = new System.Windows.Forms.Button();
            this.textboxContactTypeId = new System.Windows.Forms.TextBox();
this.labelContactTypeId = new System.Windows.Forms.Label();
...
this.labelComment = new System.Windows.Forms.Label();
            ...
            this.splitContainer1.Panel1.Controls.Add(labelContactTypeId);
...
this.splitContainer1.Panel1.Controls.Add(labelComment);
            ...
            this.splitContainer1.Panel2.Controls.Add(textboxContactTypeId);
...
this.splitContainer1.Panel2.Controls.Add(textboxComment);
            ...
            this.buttonAction.Click += new System.EventHandler(this.buttonSave_Click);
                        // 
            // textboxContactTypeId
            // 
            this.textboxContactTypeId.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textboxContactTypeId.Location = new System.Drawing.Point(4, 12);
            this.textboxContactTypeId.Name = "textboxContactTypeId";
            this.textboxContactTypeId.Size = new System.Drawing.Size(208, 20);
            this.textboxContactTypeId.TabIndex = 31;
            this.textboxContactTypeId.Leave += new System.EventHandler(this.textboxContactTypeId_Leave);
            this.textboxContactTypeId.Enabled = false;
                        // 
            // labelContactTypeId
            // 
            this.labelContactTypeId.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.labelContactTypeId.AutoSize = true;
            this.labelContactTypeId.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelContactTypeId.Location = new System.Drawing.Point(0, 12);
            this.labelContactTypeId.Name = "labelContactTypeId";
            this.labelContactTypeId.Size = new System.Drawing.Size(30, 20);
            this.labelContactTypeId.TabIndex = 14;
            this.labelContactTypeId.Text = "ID";
            this.labelContactTypeId.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
                        // 
            // textboxDescription
            // 
            ...
            // 
            // FormContactTypeEditor
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(330, 130);
            this.Controls.Add(this.splitContainer1);
            this.Name = "FormContactTypeEditor";
            this.Text = "ContactType Editor";
        ...
        private System.Windows.Forms.TextBox textboxContactTypeId;
private System.Windows.Forms.Label labelContactTypeId;
