...
{
    public partial class FormUpdatePeriodEditor : Form
    {
        private static update_period _defaultObject = new update_period();

        public int id { private set; get; }
        private update_period _cached { set; get; }
        ...
        private void reload()
        {
            using (var db = new PlanningContext())
            {
                ...
                if (this.mode != EnumEditorMode.Create)
                {
                    var obj = db.update_period.SingleOrDefault(v => v.update_period_id == this.id);
                    if (obj != null)
                    {
                        this.textboxUpdatePeriodId.Text = Convert.ToString(obj.update_period_id);
...
this.numericVersion.Value = (decimal)obj.version;
        ...
        public FormUpdatePeriodEditor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            InitializeComponent();
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = FormUpdatePeriodEditor._defaultObject;
...
obj.version = (int)this.numericVersion.Value;
                ...
                db.update_period.Add(obj);
                db.SaveChanges();
                this._cached  = obj;
                this.id       = obj.update_period_id;
                this._isDirty = false;
        ...
        private void buttonReload_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
                ...
                private void textboxUpdatePeriodId_Leave(object sender, EventArgs e)
        {
            // The Convert.ToString is just in case the value we're comparing to is something like an int.
            if (this.textboxUpdatePeriodId.Text != Convert.ToString(this._cached.update_period_id))
                this._isDirty = true;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormUpdatePeriodEditor));
            this.splitContainer1 = new System.Windows.Forms.SplitContainer();
            this.labelDirty = new System.Windows.Forms.Label();
            this.buttonDelete = new System.Windows.Forms.Button();
            this.buttonReload = new System.Windows.Forms.Button();
            this.buttonAction = new System.Windows.Forms.Button();
            this.textboxUpdatePeriodId = new System.Windows.Forms.TextBox();
this.labelUpdatePeriodId = new System.Windows.Forms.Label();
...
this.labelVersion = new System.Windows.Forms.Label();
            ...
            this.splitContainer1.Panel1.Controls.Add(labelUpdatePeriodId);
...
this.splitContainer1.Panel1.Controls.Add(labelVersion);
            ...
            this.splitContainer1.Panel2.Controls.Add(textboxUpdatePeriodId);
...
this.splitContainer1.Panel2.Controls.Add(numericVersion);
            ...
            this.buttonAction.Click += new System.EventHandler(this.buttonSave_Click);
                        // 
            // textboxUpdatePeriodId
            // 
            this.textboxUpdatePeriodId.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.textboxUpdatePeriodId.Location = new System.Drawing.Point(4, 12);
            this.textboxUpdatePeriodId.Name = "textboxUpdatePeriodId";
            this.textboxUpdatePeriodId.Size = new System.Drawing.Size(208, 20);
            this.textboxUpdatePeriodId.TabIndex = 31;
            this.textboxUpdatePeriodId.Leave += new System.EventHandler(this.textboxUpdatePeriodId_Leave);
            this.textboxUpdatePeriodId.Enabled = false;
                        // 
            // labelUpdatePeriodId
            // 
            this.labelUpdatePeriodId.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.labelUpdatePeriodId.AutoSize = true;
            this.labelUpdatePeriodId.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.labelUpdatePeriodId.Location = new System.Drawing.Point(0, 12);
            this.labelUpdatePeriodId.Name = "labelUpdatePeriodId";
            this.labelUpdatePeriodId.Size = new System.Drawing.Size(30, 20);
            this.labelUpdatePeriodId.TabIndex = 14;
            this.labelUpdatePeriodId.Text = "ID";
            this.labelUpdatePeriodId.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
                        // 
            // textboxDescription
            // 
            ...
            // 
            // FormUpdatePeriodEditor
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(330, 130);
            this.Controls.Add(this.splitContainer1);
            this.Name = "FormUpdatePeriodEditor";
            this.Text = "UpdatePeriod Editor";
        ...
        private System.Windows.Forms.TextBox textboxUpdatePeriodId;
private System.Windows.Forms.Label labelUpdatePeriodId;
