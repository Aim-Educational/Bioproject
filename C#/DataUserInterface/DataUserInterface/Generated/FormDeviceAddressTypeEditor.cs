...
{
    public partial class FormDeviceAddressTypeEditor : Form
    {
        private static device_address_type _defaultObject = new device_address_type();

        public int id { private set; get; }
        private device_address_type _cached { set; get; }
...
this.textboxComment.Text = obj.comment;
        ...
        public FormDeviceAddressTypeEditor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = FormDeviceAddressTypeEditor._defaultObject;
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new PlanningContext())
            {
                ...
                db.device_address_type.Remove(obj);
                db.SaveChanges();
                this.Close();
            }
        }
...
obj.comment = this.textboxComment.Text;
                ...
                db.SaveChanges();
                this._cached  = obj;
                this.id       = obj.device_address_type_id;
                this._isDirty = false;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormDeviceAddressTypeEditor));
...
this.splitContainer1.Panel2.Controls.Add(textboxComment);
            ...
            this.textboxDeviceAddressTypeId.TabIndex = 0;
            ...
            this.labelDeviceAddressTypeId.TabIndex = 0;
