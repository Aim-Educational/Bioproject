...
{
    public partial class Form${custom_fixedName}Editor : Form
    {
        private static ${object.className} _defaultObject = new ${object.className}();

        public int id { private set; get; }
        private ${object.className} _cached { set; get; }
        ...
        public Form${custom_fixedName}Editor(EnumEditorMode mode, int id = -1) // ID isn't always needed, e.g. Create
        {
            ...
            if (mode != EnumEditorMode.Create)
                ...
                this._cached = Form${custom_fixedName}Editor._defaultObject;
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new PlanningContext())
            {
                ...
                db.${custom_baseTypeTable}.Remove(obj);
                db.SaveChanges();
                this.Close();
            }
        }
